...
Stratus_Kirki::add_field( 'stratus_theme', [
    ...
    'label'       => esc_html__( 'Elementor Header & Footer Builder', 'stratus' ),
    'section'     => 'header_footer',
    'default' => '<div class="th-theme-support">'.esc_html__('You can now build your header and footer in Elementor. Go to Dashboard > Stratus > Header & Footer.', 'stratus').'</div><div class="th-theme-support">' . sprintf(__('<p class=""> <a href="%1$s" target="_blank">Learn more</p>', 'stratus'), 'https://themovation.helpscoutdocs.com/article/311-custom-header-footer') . '</div>',
    'priority'    => 10,
    /*'active_callback'    => array(
        array(
            'setting'  => 'thmv_hfb_switch',
            'operator' => '==',
            'value'    => true,
        )
    ),*/
